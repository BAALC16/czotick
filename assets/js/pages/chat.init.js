...
var isreplyMessage = false; // favourite btn
...
scrollToBottom(currentChatId); // // Scroll to Bottom
...
if (chatForm) {
  ...
  chatForm.addEventListener("submit", function (e) {
    ...
    chatInput.value = ""; //reply msg remove textarea
...
var messageboxcollapse = 0; //message with reply
