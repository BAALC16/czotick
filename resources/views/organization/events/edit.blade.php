...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Modifiez les informations de votre événement</p>
        </div>
    ...
    <form id="eventForm" method="POST" action="{{ route('org.events.update', ['org_slug' => $orgSlug, 'event' => $event->id]) }}" enctype="multipart/form-data" class="dropzone-form">
        @csrf
        @method('PUT')
        <input type="hidden" name="pack_type" id="selected_pack_type" value="{{ old('pack_type', $event->pack_type ?? ($ticketCustomization['pack_type'] ?? 'standard')) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="event_description"
                                  ...
                                  placeholder="Décrivez votre événement...">{{ old('event_description', $event->event_description ?? '') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number"
                               ...
                               value="{{ old('max_participants', $event->max_participants ?? 100) }}"
                               min="1"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               value="{{ old('event_start_time', $event->event_start_time ? \Carbon\Carbon::parse($event->event_start_time)->format('H:i') : '') }}"
                               required
                    ...
                    <div>
                        ...
                        <input type="text"
                               id="event_end_time"
                               name="event_end_time"
                               value="{{ old('event_end_time', $event->event_end_time ? \Carbon\Carbon::parse($event->event_end_time)->format('H:i') : '') }}"
                    ...
                    <div id="multipleTicketsOption" style="display: none;">
                        <label class="flex items-center">
                            <input type="checkbox"
                                   ...
                                   value="1"
                                   {{ old('use_multiple_tickets', $event->use_multiple_tickets ?? false) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-primary-custom focus:ring-primary-custom">
                    ...
                    <div id="singlePriceFields" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number"
                                   id="event_price"
                                   name="event_price"
                                   value="{{ old('event_price', $event->event_price ?? 0) }}"
                                   min="0"
                                   step="0.01"
                        ...
                        <div id="currencyFields">
                            ...
                            <select id="currency"
                                ...
                                <option value="XOF" {{ old('currency', $event->currency ?? 'XOF') == 'XOF' ? 'selected' : '' }}>XOF (FCFA)</option>
                                <option value="EUR" {{ old('currency', $event->currency ?? 'XOF') == 'EUR' ? 'selected' : '' }}>EUR (€)</option>
                                <option value="USD" {{ old('currency', $event->currency ?? 'XOF') == 'USD' ? 'selected' : '' }}>USD ($)</option>
                            </select>
                            @error('currency')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox"
                                           ...
                                           value="1"
                                           {{ old('allow_partial_payment', $event->allow_partial_payment ?? false) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-primary-custom focus:ring-primary-custom">
                                ...
                                <div id="partialPaymentAmountField" class="mt-2 ml-6" style="display: none;">
                                    ...
                                    <input type="number"
                                           ...
                                           value="{{ old('partial_payment_amount', $event->partial_payment_amount ?? 0) }}"
                                           min="0"
                                           step="0.01"
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox"
                                           ...
                                           value="1"
                                           {{ old('allow_reservation', $event->allow_reservation ?? false) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-primary-custom focus:ring-primary-custom">
                                ...
                                <div id="reservationFields" class="mt-2 ml-6 space-y-2" style="display: none;">
                                    <div>
                                        ...
                                        <input type="number"
                                               ...
                                               value="{{ old('reservation_amount', $event->reservation_amount ?? 0) }}"
                                               min="0"
                                               step="0.01"
                                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-custom focus:border-transparent">
                                    </div>
                                    <div>
                                        ...
                                        <textarea id="reservation_terms"
                                                  ...
                                                  rows="3"
                                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-custom focus:border-transparent"
                                                  placeholder="Ex: Le solde doit être payé 48h avant l'événement">{{ old('reservation_terms', $event->reservation_terms ?? '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="wizard-step" id="step6">
            ...
            <div id="premiumPack" class="form-section" style="display: none;">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="mb-3 text-xs text-gray-500">
                            ...
                            @if($ticketCustomization && isset($ticketCustomization['template_path']))
                                <span class="text-green-600 font-medium">• Un ticket existe déjà. Vous pouvez le remplacer en uploadant un nouveau fichier.</span>
                            @endif
                        </p>
                            ...
                            <div class="dz-message">
                                ...
                                @if($ticketCustomization && isset($ticketCustomization['template_path']))
                                    <p class="text-blue-600 text-sm mt-2 font-medium">
                                        <i class="fas fa-info-circle mr-1"></i>Remplacer le ticket existant
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        @enderror
                        @if($ticketCustomization && isset($ticketCustomization['template_path']))
                            <div id="existingTicketBadge" class="mt-2">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                    <i class="fas fa-check-circle mr-1"></i>Spécimen existant
                                </span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div id="premiumInteractivePreview" class="mt-6" style="display: {{ ($ticketCustomization && isset($ticketCustomization['template_path'])) ? 'block' : 'none' }};">
                                    ...
                                    <div class="relative inline-block w-full">
                                        <div class="border border-gray-300 rounded-lg p-3 bg-gray-50 shadow-inner overflow-auto" style="max-height: 600px; position: relative;">
                                            <div id="premiumTicketContainer" class="relative inline-block mx-auto" style="position: relative; display: inline-block;">
                                                <img id="premiumTicketImage"
                                                     class="max-w-full h-auto block"
                                                     style="display: block; max-width: 100%;"
                                                     alt="Ticket preview"
                                                     @if($ticketCustomization && isset($ticketCustomization['template_path']))
                                                     src="{{ url('public/' . $ticketCustomization['template_path']) }}"
                                                     @endif>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition cursor-pointer">
                                            <input type="checkbox"
                                                   ...
                                                   name="premium_elements[]"
                                                   value="seat"
                                                   {{ (isset($ticketCustomization['elements']) && in_array('seat', $ticketCustomization['elements'])) || in_array('seat', old('premium_elements', [])) ? 'checked' : '' }}
                                                   class="rounded border-gray-300 text-primary-custom focus:ring-primary-custom">
                                        ...
                                        <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition cursor-pointer">
                                            <input type="checkbox"
                                                   ...
                                                   name="premium_elements[]"
                                                   value="ticket_type"
                                                   {{ (isset($ticketCustomization['elements']) && in_array('ticket_type', $ticketCustomization['elements'])) || in_array('ticket_type', old('premium_elements', [])) ? 'checked' : '' }}
                                                   class="rounded border-gray-300 text-primary-custom focus:ring-primary-custom">
                                        ...
                                        <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition cursor-pointer">
                                            <input type="checkbox"
                                                   ...
                                                   name="premium_elements[]"
                                                   value="amount"
                                                   {{ (isset($ticketCustomization['elements']) && in_array('amount', $ticketCustomization['elements'])) || in_array('amount', old('premium_elements', [])) ? 'checked' : '' }}
                                                   class="rounded border-gray-300 text-primary-custom focus:ring-primary-custom">
                    ...
                    <div>
                        <label for="registration_open" class="flex items-center">
                            <input type="checkbox"
                                   ...
                                   value="1"
                                   {{ old('registration_open', $event->registration_open ?? true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-primary-custom focus:ring-primary-custom">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('registration_start_date', $event->registration_start_date ? \Carbon\Carbon::parse($event->registration_start_date)->format('Y-m-d H:i') : '') }}"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('registration_end_date', $event->registration_end_date ? \Carbon\Carbon::parse($event->registration_end_date)->format('Y-m-d H:i') : '') }}"
...
<script>
    ...
    (function() {
        window.goToStep = function(step) {
            ...
            // Si on arrive à l'étape 6 (Personnalisation), afficher la bonne section selon le pack type
            if (step === 6) {
                const selectedPackType = document.getElementById('selected_pack_type');
                const packType = selectedPackType ? selectedPackType.value : '{{ $event->pack_type ?? ($ticketCustomization['pack_type'] ?? 'standard') }}';
                const standardPack = document.getElementById('standardPack');
                const premiumPack = document.getElementById('premiumPack');
                const customPack = document.getElementById('customPack');

                if (standardPack) standardPack.style.display = packType === 'standard' ? 'block' : 'none';
                if (premiumPack) premiumPack.style.display = packType === 'premium' ? 'block' : 'none';
                if (customPack) customPack.style.display = packType === 'custom' ? 'block' : 'none';

                // Si c'est le pack premium et qu'une image existe, afficher la prévisualisation
                if (packType === 'premium') {
                    setTimeout(function() {
                        const premiumTicketImage = document.getElementById('premiumTicketImage');
                        const premiumInteractivePreview = document.getElementById('premiumInteractivePreview');

                        if (premiumTicketImage && premiumInteractivePreview) {
                            // Si l'image a un src et est chargée
                            if (premiumTicketImage.src && premiumTicketImage.src !== window.location.href) {
                                if (premiumTicketImage.complete && premiumTicketImage.naturalWidth > 0) {
                                    premiumInteractivePreview.style.display = 'block';
                                } else {
                                    premiumTicketImage.onload = function() {
                                        premiumInteractivePreview.style.display = 'block';
                                    };
                                }
                            }
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (selectedPackType.value && selectedPackType.value !== 'custom') {
            ...
            // Afficher la bonne section de personnalisation au chargement si on est déjà à l'étape 6
    ...
    function initializeDropzones() {
        ...
        if (dropzoneStandardEl && !dropzoneStandard) {
            ...
            if (dropzoneStandardEl.dropzone) {
                ...
                url: "{{ route('org.events.update', ['org_slug' => $orgSlug, 'event' => $event->id]) }}", // URL nécessaire même si autoProcessQueue est false
        ...
        if (dropzonePremiumEl && !dropzonePremium) {
            ...
            dropzonePremium = new Dropzone("#dropzonePremium", {
                ...
                init: function() {
                    ...
                    // Charger le ticket existant s'il y en a un
                    @if($ticketCustomization && isset($ticketCustomization['template_path']))
                    const existingTemplatePath = '{{ url('public/' . $ticketCustomization['template_path']) }}';
                    const existingTicketImage = document.getElementById('premiumTicketImage');
                    const interactivePreview = document.getElementById('premiumInteractivePreview');

                    if (existingTemplatePath && existingTicketImage) {
                        // Créer un mock file pour Dropzone
                        const mockFile = {
                            name: existingTemplatePath.split('/').pop(),
                            size: 0,
                            type: 'image/png',
                        ...
                        // Ajouter le fichier mock à Dropzone
                        dropzone.emit("addedfile", mockFile);
                        dropzone.emit("thumbnail", mockFile, existingTemplatePath);
                        dropzone.emit("complete", mockFile);
                        dropzone.files.push(mockFile);

                        // Charger l'image dans l'aperçu si elle n'est pas déjà chargée
                        if (existingTicketImage.src !== existingTemplatePath) {
                            existingTicketImage.src = existingTemplatePath;
                        }

                        // Afficher la prévisualisation immédiatement si l'image est déjà chargée
                        if (existingTicketImage.complete && existingTicketImage.naturalWidth > 0) {
                            if (interactivePreview) {
                                interactivePreview.style.display = 'block';
                            }
                        } else {
                            existingTicketImage.onload = function() {
                                if (interactivePreview) {
                                    interactivePreview.style.display = 'block';
                                }
                            };
                    ...
                    dropzone.on("addedfile", function(file) {
                        // Masquer le badge "Spécimen existant" si un nouveau fichier est ajouté
                        const existingBadge = document.getElementById('existingTicketBadge');
                        if (existingBadge) {
                            existingBadge.innerHTML = '<span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800"><i class="fas fa-upload mr-1"></i>Nouveau ticket</span>';
                        }
                        if (dropzone.files.length > 1) {
                            dropzone.removeFile(dropzone.files[0]);
                        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Vérifier si une image de ticket premium existe déjà et afficher la prévisualisation
        const premiumTicketImage = document.getElementById('premiumTicketImage');
        const premiumInteractivePreview = document.getElementById('premiumInteractivePreview');

        if (premiumTicketImage && premiumInteractivePreview) {
            // Si l'image a déjà un src (chargée depuis le HTML)
            if (premiumTicketImage.src && premiumTicketImage.src !== window.location.href) {
                if (premiumTicketImage.complete) {
                    // Image déjà chargée
                    premiumInteractivePreview.style.display = 'block';
                } else {
