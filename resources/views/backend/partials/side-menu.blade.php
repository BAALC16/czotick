<li class="list-group-item pt-6 pb-4">
  ...
  <ul class="list-group list-group-no-border rounded-lg">
    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
      <a href="#services_collapse" class="text-heading lh-1 sidebar-link d-flex align-items-center"
      ...
      <div class="card card-body border-0 bg-transparent py-0 pl-6">
        <ul class="list-group list-group-flush list-group-no-border">
          ...
          @can('create', App\Models\Service::class)
            <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
              <a class="text-heading lh-1 sidebar-link" href="{{ route('services.create') }}">Ajouter un service</a>
            </li>
          @endcan
          @can('viewAny', App\Models\Reservation::class)
            <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
              <a class="text-heading lh-1 sidebar-link" href="{{route('reservations.index')}}">Demandes</a>
            </li>
          @endcan
        </ul>
      </div>
    ...
    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
      <a href="#reservations_collapse" class="text-heading lh-1 sidebar-link d-flex align-items-center" data-toggle="collapse" aria-haspopup="true" aria-expanded="false">
        <span class="sidebar-item-icon d-inline-block mr-3 text-muted fs-20">
