...
@section('title') Librairie @endsection
@section('content')
@component('components.breadcrumb')
@slot('li_1') Librairie @endslot
@slot('title') Tous les Documents @endslot
@endcomponent
<div class="row">
    <div class="col-lg-12">
        <div class="card" id="orderList">
            <div class="card-header  border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Liste des Documents</h5>
                    <div class="flex-shrink-0">
                        @can('create', App\Models\Article::class)
                            <a href="{{ route('library.create') }}" class="btn btn-success add-btn" id="create-btn">Ajouter
                            </a>
                        @endcan
                    </div>
                </div>
                        ...
                        <table class="table table-nowrap align-middle" id="orderTable">
                            <thead class="text-muted table-light">
                                <tr class="text-uppercase">
                                    ...
                                    <th class="sort" data-sort="category">Taille</th>
                                    {{-- <th class="sort" data-sort="category">Nombre de téléchargement</th> --}}
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="date">{{ Carbon::parse($library->created_at)->isoFormat("DD MMM YYYY") }}
                                    </td>
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top" title="Télécharger">
                                                <a href="{{ url('/public/storage/'.$library->url) }}"
                                            ...
                                            <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                ...
                                                <a href="{{ route('library.edit', ['library' => $library, 'continue' => url()->full()]) }}"
                                                    class="text-primary d-inline-block edit-item-btn">
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a data-href="{{ route('library.destroy.library', $library) }}" class="click-to-delete-row"
