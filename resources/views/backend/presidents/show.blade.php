...
@endslot
@endcomponent
<form method="POST" id="form" @if ($edit) action="{{ route('presidents.update', $office) }}" @else
    ...
    <div class="row  justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="project-title-input" name="firstname"
                            value="{{ $president->firstname }}" />
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="project-title-input">Prénoms</label>
                        <input type="text" class="form-control" id="project-title-input" name="lastname"
                            value="{{ $president->lastname }}" />
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="project-title-input">Email</label>
                        <input type="email" class="form-control" id="project-title-input" name="email"
                            value="{{ $president->email }}" />
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="project-title-input">Fonction</label>
                        <input type="text" class="form-control" id="project-title-input" name="job"
                            value="{{ $president->job }}" />
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-4">
                        <a><img src="{{ Storage::url("{$president->image}") }}" alt="{{$president->title}}" style="width:100%;">
                        </a>
                    </div>
                </div>
            </div>
