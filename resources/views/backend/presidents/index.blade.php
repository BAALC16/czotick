...
@section('title') Liste du PEL @endsection
@section('content')
@component('components.breadcrumb')
@slot('li_1') PEL @endslot
        ...
        <div class="card" id="orderList">
            <div class="card-header  border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Liste du PEL</h5>
                    <div class="flex-shrink-0">
                        <a href="{{ route('presidents.create') }}" class="btn btn-success add-btn" id="create-btn">Ajouter
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                           ...
                                           <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                ...
                                                <a href="{{ route('presidents.edit', ['president' => $president, 'continue' => url()->full()]) }}"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a data-href="{{ route('presidents.destroy.president', $president) }}" class="click-to-delete-row"
                                                    data-confirm="Souhaitez-vous vraiment supprimer ce président ?"
                                                    data-toggle="tooltip"
