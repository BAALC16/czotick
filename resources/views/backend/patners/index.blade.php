...
@section('title') Liste des partenaires @endsection
@section('content')
@component('components.breadcrumb')
@slot('li_1') Partenaire @endslot
@slot('title') Tous les partenaires @endslot
@endcomponent
<div class="row">
    <div class="col-lg-12">
        <div class="card" id="orderList">
            <div class="card-header  border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Liste des partenaires</h5>
                    <div class="flex-shrink-0">
                        <a href="{{ route('patners.create') }}" class="btn btn-success add-btn" id="create-btn">Ajouter
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-nowrap align-middle" id="orderTable">
                            <thead class="text-muted table-light">
                                <tr class="text-uppercase">
                                    ...
                                    <th class="sort" data-sort="website">Site web</th>
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="date">{{ Carbon::parse($patner->created_at)->isoFormat("DD MMM YYYY") }}
                                    </td>
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top" title="D&eacute;tails">
                                                <a href="{{ route('patners.show', ['patner' => $patner, 'continue' => url()->full()]) }}"
                                            ...
                                            <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                ...
                                                <a href="{{ route('patners.edit', ['patner' => $patner, 'continue' => url()->full()]) }}"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a data-href="{{ route('patners.destroy.patner', $patner) }}" class="click-to-delete-row"
                                                    data-confirm="Souhaitez-vous vraiment supprimer cet patner ?"
                                                    data-toggle="tooltip"
