    ...
    <div class="row  justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="input-group mb-3">
                        ...
                        <input readonly type="text" class="form-control" id="project-title-input" name="name"
                            value="{{ $patner->name }}"  />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input readonly type="email" class="form-control" id="project-title-input" name="email"
                            value="{{ $patner->email }}"  />
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="project-title-input">Contact</label>
                        <input readonly type="text" class="form-control" id="project-title-input" name="contact"
                            value="{{ $patner->contact }}" />
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="project-title-input">Site web</label>
                        <input readonly type="text" class="form-control" id="project-title-input" name="website"
                            value="{{ $patner->website }}" />
                    </div>
                </div>
                <!-- end card body -->
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-4">
                        <a><img src="{{ Storage::url("{$patner->image}") }}" alt="{{$patner->title}}" style="width:100%;">
                        </a>
                    </div>
                </div>
            </div>
