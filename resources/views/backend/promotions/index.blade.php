...
@slot('title') Tous les Promotions @endslot
@endcomponent
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                          @can('create', App\Models\Promotion::class)
                            <a href="{{ route('promotions.create') }}" class="btn btn-success add-btn" id="create-btn" >Ajouter </a>
                          @endcan
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-nowrap align-middle" id="orderTable">
                            <thead class="text-muted table-light">
                                <tr class="text-uppercase">
                                    ...
                                    <th class="sort" data-sort="status">Req.</th>
                                        ...
                                        @endcan
                                          @can('update', $promotion)
                                            <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Modifier">
                                                <a href="{{ route('promotions.edit', ['promotion' => $promotion, 'continue' => url()->full()]) }}" class="text-primary d-inline-block edit-item-btn">
                                          ...
                                          @can('delete', $promotion)
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Supprimer">
                                                <a href="#deleteOrder" data-confirm="Souhaitez-vous vraiment supprimer ce promotion ?" data-href="{{ route('promotions.destroy', $promotion) }}" data-toggle="tooltip" class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal">
