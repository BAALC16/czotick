      ...
      <div class="section-content">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="title text-white">Actualité</h2>
                        ...
                        <div class="tm-sc-blog blog-style-default mb-lg-30">
                            ...
                            <div class="entry-header">
                                ...
                                <div class="post-thumb-inner">
                                    <div class="thumb"> <img src="/public/{{ $post->image }}" alt="Image"/></div>
                                </div>
                                </div>
                                <a class="link" href="{{ route('public.single-post', ['slug' => str_slug($post->title)]) }}"><i class="fa fa-link"></i></a>
                            </div>
                            <div class="entry-content" style="height: 400px">
                                <h5 class="entry-title"><a href="{{ route('public.single-post', ['slug' => str_slug($post->title)]) }}" rel="bookmark">{{  $post->title }}</a></h5>
                                ...
                                <div class="post-btn-readmore"> <a href="{{ route('public.single-post', ['slug' => str_slug($post->title)]) }}" class="btn btn-plain-text-with-arrow"> Lire plus </a></div>
